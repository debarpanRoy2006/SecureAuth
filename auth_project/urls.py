...
"""
# auth_project/auth_project/urls.py
...
urlpatterns = [
    ...
    path('', include('auth_app.urls')), # Include your app's URLs

    # Django's built-in authentication URLs for password reset
    path('password_reset/',
         auth_views.PasswordResetView.as_view(template_name='auth_app/password_reset_form.html'),
         name='password_reset'),
